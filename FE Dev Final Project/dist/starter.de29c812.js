    ...
    `;
        ...
        dkgmw: [
            function (require, module, exports, __globalThis) {
                ...
                const addListenerToNavigation = () => {
                    ...
                    addNavListener(
                        "aboutPage",
                        (0, _aboutPageJs.renderAboutPage),
                    );
        ...
        cykiM: [
            function (require, module, exports, __globalThis) {
                ...
                const renderCardSetsPage = () => {
                    ...
                    const pageHeader = (0,
                    _utilityRenderFunctionsJs.createHeader)(
                        "h2",
                        "Study Set Library",
                        "study-set-header",
                    );
        ...
        fMRv2: [
            function (require, module, exports, __globalThis) {
                ...
                const generateFlashCard = (card) => {
                    ...
                    const descriptionSide = renderSide(
                        card.description,
                        "description",
                    );
                ...
                const renderFlashCards = (set, index = 0) => {
                    ...
                    if (set.length !== 0) {
                        ...
                        const previousBtn = createNavigationButton(
                            "Previous",
                            () => {
        ...
        "92YE4": [
            function (require, module, exports, __globalThis) {
                ...
                const renderCardForm = (set) => {
                    ...
                    const termLabel = (0,
                    _utilityRenderFunctionsJs.createLabel)("Term", "termInput");
                    // Creates input for the term
                    const termInput = (0,
                    _utilityRenderFunctionsJs.createInput)("termInput");
                    // Creates label for description
                    const descriptionLabel = (0,
                    _utilityRenderFunctionsJs.createLabel)(
                        "Description",
                        "descriptionInput",
                    );
                    // Creates input for description
                    const descriptionInput = (0,
                    _utilityRenderFunctionsJs.createInput)("descriptionInput");
                    //Creates submit input
                    const addCardBtn = (0,
                    _utilityRenderFunctionsJs.createSubmitButton)("Add Card");
                    ...
                    cardForm.addEventListener("submit", (e) => {
                        ...
                        if (!term && !description)
                            (0, _errorsJs.showError)(
                                "TERM AND DESCRIPTION CANNOT BE EMPTY",
                            );
                        else if (!term)
                            (0, _errorsJs.showError)("TERM CANNOT BE EMPTY");
                        else if (!description)
                            (0, _errorsJs.showError)(
        ...
        "60GGE": [
            function (require, module, exports, __globalThis) {
                ...
                const submitSet = (e, setCards) => {
                    ...
                    if (!title)
                        (0, _errorsJs.showError)("TITLE CANNOT BE EMPTY");
                    else {
                        //Creates set object
        ...
        aRpDC: [
            function (require, module, exports, __globalThis) {
                ...
                const renderAboutPage = () => {
                    ...
                    const subHeading = (0,
                    _utilityRenderFunctionsJs.createElement)(
                        "h3",
                    ...
                    const aboutImage = (0,
                    _utilityRenderFunctionsJs.createImage)(
        ...
        aAmIa: [
            function (require, module, exports, __globalThis) {
                ...
                var _homePagePngDefault =
                    parcelHelpers.interopDefault(_homePagePng);
                //Helper functions
                var _utilityRenderFunctionsJs = require("./utilityRenderFunctions.js");
                //Renders home page
